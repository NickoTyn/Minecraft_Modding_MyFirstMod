package net.nickotyn.myfirstmod.block.entity.renderer;
...
public class ToolForgeEntityRenderer implements BlockEntityRenderer<ToolForgeEntity> {
    public ToolForgeEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(ToolForgeEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
